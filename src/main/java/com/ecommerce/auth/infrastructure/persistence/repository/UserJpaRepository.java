...
public interface UserJpaRepository extends JpaRepository<UserJpaEntity, UUID> {
    ...
    // Fetch roles + permissions trong 1 query Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â trĂ„â€Ă‚Â¡nh N+1 problem
    @Query("""
    ...
    // Fetch roles + permissions cho findByPhoneNumber Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â trĂ„â€Ă‚Â¡nh N+1
    @Query("""
            SELECT u FROM UserJpaEntity u
            LEFT JOIN FETCH u.roles r
            LEFT JOIN FETCH r.permissions
