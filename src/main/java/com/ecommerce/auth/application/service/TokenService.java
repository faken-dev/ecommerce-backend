 ...
 * BOTH either succeed or BOTH rollback Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â eliminating the orphaned Redis entry
...
public class TokenService {
     ...
     * We use a Redis WATCH on the family key as an optimistic lock Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â if another
    ...
    public AuthTokenResponse generateTokens(User user, String deviceInfo, String ipAddress) {
        ...
        // Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬ Atomic Redis + DB write via Redis MULTI/EXEC Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬Ä‚Â¢Ă¢â‚¬ÂĂ¢â€Â¬
        // If DB save throws, the EXEC is never called Ä‚Â¢Ă¢â‚¬Â Ă¢â‚¬â„¢ Redis side-effect rolls back.
        // If Redis WATCH fails (concurrent modification), we retry up to 3Ă„â€Ă¢â‚¬â€.
     ...
     * (exec() returns null) and we retry with a fresh WATCH Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â up to 3 times.
     *
    ...
    private void executeAtomicTokenCreation(UUID userId, long generation, RefreshToken refreshToken) {
        ...
        for (int attempt = 1; attempt <= 3; attempt++) {
            ...
            if (result != null) {
                // Redis WATCH/MULTI succeeded Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â proceed to DB save.
                // If DB fails, @Transactional rolls back the entire method.
                refreshTokenRepository.save(refreshToken);
                return; // success
            }

            // result == null Ä‚Â¢Ă¢â‚¬Â Ă¢â‚¬â„¢ WATCH conflict Ä‚Â¢Ă¢â‚¬Â Ă¢â‚¬â„¢ another thread modified the key Ä‚Â¢Ă¢â‚¬Â Ă¢â‚¬â„¢ retry
