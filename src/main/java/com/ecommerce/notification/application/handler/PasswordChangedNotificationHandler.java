...
public class PasswordChangedNotificationHandler {
    ...
    /**
     * Fires AFTER the transaction commits Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â ensures the password was actually changed
    ...
    public void handle(PasswordChangedEvent event) {
        ...
        try {
            ...
            // Security notification failure is non-critical Ä‚Â¢Ă¢â€Â¬Ă¢â‚¬Â don't block the password change
        }
    }
